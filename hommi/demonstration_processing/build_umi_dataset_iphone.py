...
from hommi.demonstration_processing.build_umi_dataset_stages.gen_dataset_plan import gen_dataset_plan
from hommi.demonstration_processing.build_umi_dataset_stages.gen_replay_buffer import gen_replay_buffer
from hommi.common.replay_buffer_util import print_replay_buffer_umi
...
def main(cfg: DictConfig):
    ...
    if 'dataset_plan' in stages:
        if os.path.exists(dataset_plan_path):
            if overwrite:
                ...
                exit()
        gen_dataset_plan(session_dir, dataset_plan_path, cfg.task_names, rotate_head=cfg.rotate_head)
    ...
    if 'replay_buffer' in stages:
        ...
        print_replay_buffer_umi(replay_buffer_path, vis_frame=cfg.replay_buffer.vis_rgb, vis_video=cfg.replay_buffer.vis_video)
