...
from hommi.common.trajectory_util import vis_video_aligned_trajectories, get_open3d_geo_trajectories
...
if __name__ == '__main__':
    ...
    if args.mode == 'viewer':
        ...
        geometries = get_open3d_geo_trajectories([poses])
        ...
        vis_video_aligned_trajectories(video_path, out_path, poses, is_lost)
