...
def main(cfg: DictConfig):
    ...
    all_stages = ['group', 'detect', 'calibrate', 'label', 'align', 'visualize']
    ...
    if 'visualize_pointmap' in stages:
        print(blue("\n--- POINTMAP VISUALIZATION STAGE ---"))
        visualize_pointmap_alignment(get_demonstration_iterator, cfg.visualize_pointmap)

    if 'visualize' in stages:
        print(blue("\n--- VISUALIZE STAGE ---"))
        visualize_iphone_data(get_demonstration_iterator, cfg.visualize)
        visualize_aligned_iphone_data(get_demonstration_iterator, cfg.visualize)
